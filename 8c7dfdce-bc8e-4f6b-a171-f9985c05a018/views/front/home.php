            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo base_url().$this->session->userdata('REDIRECT_URL').'dashboard'?>">My Dashboard</a></li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-login">
                            ...
                            <?php echo form_open('login/checklogin',['name'=>'formlogin','id'=>'formlogin','method'=>'post','onclick'=>'return false'])?>
                            <div class="form-group" id="errorMsg" style="color:#f51d1d;display:none"></div>

                                <div class="form-group">

                                    <label>Email address</label>

                                    <input class="form-control"  placeholder="Enter email" aria-invalid="false" name="username" id="username" type="email">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control"  placeholder="Password" aria-invalid="false" name="password" id="password" type="password">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label><input type="checkbox" id="loginremenberme" name="loginremenberme" value="1"> Remember Me</label>
                                        <a class="pull-right" href="<?php echo base_url().'login/forgotpassword';?>">Forgot passwoprd</a>

                                    </div>

                                </div>

                                <div><input type="submit" id="login_btn" name="loginbutton" value="LOGIN"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="content">
                                ...
                                <p>An dico iusto tacimates qui. Vel ne postea signiferumque. Te tale suas consequat cum, cu nisl sumo nulla eum. Mea tota inciderint eu, quo accusam dolores voluptatum ea. Vim mollis commune propriae cu, qui fugit graece verterem eu. Qui ad dicunt appareat, te illum saepe sea.</p>

                                <p>No populo mediocrem patrioque has, corpora perfecto pertinacia no per. An virtute epicurei temporibus pro, pri ex rebum erroribus, et illum iudico vivendum mel. Vel cu vide causae vivendum, sensibus persequeris quo ad, ut pri nonumes suavitate. Duo patrioque democritum an, id est elitr labore. </p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <?php echo form_open('home/contactus',['name'=>'frm_driver_contuct','id'=>'frm_driver_contuct','onsubmit'=>'return false','method'=>'POST'])?>
                                <div class="row">
                                    <div class="col-lg-10 alert alert-success hide form-control " id="consuccess"></div>
                                <div class="col-lg-10 alert alert-info hide form-control " id="conwarning"></div>
                                    <div class="col-sm-6 form-group">
                                        <input type="text" class="form-control" name="fullname" id="fullname" placeholder="Name" required>
                                    <div id="error_fullname" class="error_div"></div>
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <input type="text" class="form-control" name="conemail" id="conemail" placeholder="Email" required>
                                        <div id="error_conemail" class="error_div"></div>
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <input type="text" class="form-control" name="conphone" id="conphone" placeholder="Phone" required>
                                        <div id="error_conphone" class="error_div"></div>
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <input type="text" class="form-control" name="conlocation" id="conlocation" placeholder="Location" required>
                                        <div id="error_conlocation" class="error_div"></div>
                                    </div>

                                    <div class="col-sm-12 form-group">
                                        <textarea class="form-control" name="conmessage" id="conmessage" placeholder="Message"></textarea>
                                    <div id="error_conmessage" class="error_div"></div></div>

                                    <div class="col-sm-12 text-right">

                                        <input type="submit" id="consubmit" value="SEND TO US">
